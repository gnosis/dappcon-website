...
export const CookiePolicyPageTemplate = ({ title, body }) => (
  <PageWrapper>
    <ContentWrapper>
...
const CookiePolicyPage = props => {
  ...
  return <CookiePolicyPageTemplate title={title} body={rawMarkdownBody} />
}
...
export const pageQuery = graphql`
  query {
    pageData: markdownRemark(frontmatter: { templateKey: { eq: "cookie-policy-page" } }) {
      rawMarkdownBody
      frontmatter {
        title
      }
